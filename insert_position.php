<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $insert = "INSERT INTO `position`(`position_id`, `positionname`) VALUES (NULL,'$pname')";
		...
		<div class="container-fluid">
			...
			<div class="col-sm-4">
				<div class="form-group">
					...
					<input type="text" class="form-control text-field" id="pname" name="pname" placeholder="Position Name" autofocus required>
        </div>
