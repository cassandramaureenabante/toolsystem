<?php
    ...
    $department_err = $departmentcode_err = '';
    ...
    if(isset($_POST['submit'])){
        ...
        $insert = "INSERT INTO `department`(`department_id`, `departmentname`,`departmentcode`) VALUES (NULL,'$dname','$dcode')";
            ...
            <div style="text-align:center" class="col-sm-3 col-sm-offset-2">
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<input type="text" class="form-control text-field" id="dcode" name="dcode" placeholder="Department Code" autofocus required>
			        </div>
                    <div class="form-group">
                        <label for="department-name">Department Name</label>
                        <input type="text" class="form-control text-field" id="dname" name="dname" placeholder="Department Name" autofocus required>
                    </div>
