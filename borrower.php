...
<body>
    <div class="background">
        ...
        <a class="btn btn-primary" href="login.php">Logout</a></button>
				...
				<br><br><br><br><br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;;
		<a class="btn btn-primary" href="insert_borrower.php">Add Borrower</a></button>
	</div>
		<div class="container-fluid">
            <div style="text-align:center;" class="col-sm-offset-2">
                <div class="col-sm-10">
                <div class="form-group">
				<h1> BORROWERS INFORMATION</h1>
						...
						<thead class="thead-inverse">
							...
							<?php
								...
								$sql = "SELECT * as ID, first_name as 'First Name', last_name as 'Last Name', department as 'Department' section as 'Section' position as 'Position', contactnumber as 'Contactnumber' email_address as 'Email Address' Address as 'Address', from borrower";
							...
							?>	
								<th class="" colspan="">Borrower ID</th>
								<th class="text-center" colspan="">First Name</th>
								<th class="text-center" colspan="">Last Name</th>
								<th class="text-center" colspan="">Contact Number</th>
								<th class="text-center" colspan="">Email Address</th>
								<th class="text-center" colspan="">Address</th>
								<th class="text-center" colspan="">Department Code</th>
								<th class="text-center" colspan="">Section Name</th>
								<th class="text-center" colspan="">Position type</th>
						...
						<tbody>
							<?php 
							$sql = "select * from borrower,department,section,position WHERE borrower.department = department.department_id AND borrower.section=section.section_id AND borrower.position = position.position_id ";
							...
							<tr class ="text-center">
								...
								<td> <a class="btn btn-warning" href="update_borrower.php?id=<?php echo $row[0]; ?>">Update </a> </td>
								<td> <a class="btn btn-danger" href="delete_borrower.php?id=<?php echo $row[0];  ?>">Delete</a> </td
							</tr>
